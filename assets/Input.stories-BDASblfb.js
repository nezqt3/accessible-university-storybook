import{n as e,t}from"./iframe-a2mGhWt8.js";import{t as n}from"./createLucideIcon-Dmex4IOU.js";import{t as r}from"./search-DFPJcgcq.js";import{t as i}from"./FormField-BmDa9N2-.js";var a=n(`user`,[[`path`,{d:`M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2`,key:`975kel`}],[`circle`,{cx:`12`,cy:`7`,r:`4`,key:`17ys0d`}]]),o=e(),s=t();const c=(0,o.forwardRef)(function({label:e,error:t,helperText:n,iconLeft:r,fieldSize:a=`md`,wrapperClassName:c,id:l,className:u=``,required:d,...f},p){let m=(0,o.useId)(),h=l??`ui-input-${m}`,g=t||n?`${h}-description`:void 0;return(0,s.jsx)(i,{htmlFor:h,label:e,required:d,error:t,helperText:n,descriptionId:g,className:c,children:(0,s.jsxs)(`span`,{className:[`ui-input`,`ui-input--${a}`,r?`ui-input--with-icon`:``,u].filter(Boolean).join(` `),children:[r?(0,s.jsx)(`span`,{className:`ui-input__icon`,"aria-hidden":`true`,children:r}):null,(0,s.jsx)(`input`,{...f,ref:p,id:h,required:d,className:`ui-field-control ui-input__control`,"aria-invalid":t?!0:void 0,"aria-describedby":g})]})})});c.__docgenInfo={description:``,methods:[],displayName:`Input`,props:{label:{required:!1,tsType:{name:`ReactNode`},description:``},error:{required:!1,tsType:{name:`string`},description:``},helperText:{required:!1,tsType:{name:`ReactNode`},description:``},iconLeft:{required:!1,tsType:{name:`ReactNode`},description:``},fieldSize:{required:!1,tsType:{name:`union`,raw:`"md" | "lg"`,elements:[{name:`literal`,value:`"md"`},{name:`literal`,value:`"lg"`}]},description:`Размер контрола: md 44px, lg 48px`,defaultValue:{value:`"md"`,computed:!1}},wrapperClassName:{required:!1,tsType:{name:`string`},description:`className внешней обертки поля`},className:{defaultValue:{value:`""`,computed:!1},required:!1}},composes:[`InputHTMLAttributes`]};var l={title:`UI/Input`,component:c,parameters:{layout:`padded`},args:{label:`Email`,placeholder:`Введите email`}};const u={},d={args:{helperText:`Используйте корпоративную почту`}},f={args:{error:`Некорректный email`,defaultValue:`user@`}},p={args:{disabled:!0,defaultValue:`user@university.ru`}},m={args:{required:!0}},h={render:()=>(0,s.jsxs)(`div`,{style:{display:`grid`,gap:16},children:[(0,s.jsx)(c,{label:`Логин`,placeholder:`Логин или почта`,iconLeft:(0,s.jsx)(a,{size:18})}),(0,s.jsx)(c,{label:`Поиск`,type:`search`,placeholder:`Найти ресурс`,iconLeft:(0,s.jsx)(r,{size:18})})]})},g={render:()=>(0,s.jsxs)(`div`,{style:{display:`grid`,gap:16},children:[(0,s.jsx)(c,{label:`Размер md`,placeholder:`44px`,fieldSize:`md`}),(0,s.jsx)(c,{label:`Размер lg`,placeholder:`48px`,fieldSize:`lg`})]})},_={render:function(){let[e,t]=(0,o.useState)(``);return(0,s.jsx)(c,{label:`Email`,placeholder:`Введите email`,value:e,error:e.length>0&&!e.includes(`@`)?`Нужен символ @`:void 0,helperText:`Подсказка исчезает при ошибке`,onChange:e=>t(e.target.value)})}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{}`,...u.parameters?.docs?.source}}},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
